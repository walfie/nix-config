...
/usr/libexec/PlistBuddy -c "Set :DesktopViewSettings:IconViewSettings:iconSize 75" ~/Library/Preferences/com.apple.finder.plist
...
# Disable some spotlight search results
